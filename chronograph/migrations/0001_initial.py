    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atomic', models.BooleanField(default=True, help_text="If checked, the command is run wrapped in a database transaction, using Djano's atomic context manager.", verbose_name='atomic')),
                ...
                ('started_on', models.DateTimeField(verbose_name='started running', null=True, editable=False, blank=True)),
